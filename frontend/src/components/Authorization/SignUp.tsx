...
export default function SignUp() {
    ...
    function handleSubmit(event: FormEvent<HTMLFormElement>): void {
        ...
        const nameElement = document.getElementById("name-input-registration") as HTMLInputElement;
        const emailElement = document.getElementById("email-input-registration") as HTMLInputElement;
        const passwordElement = document.getElementById("password-input-registration") as HTMLInputElement;
        const repeatedPasswordElement = document.getElementById("password-confirmation") as HTMLInputElement;
        ...
        if (password !== repeatedPassword) {
            const registrationErrorText = document.getElementById("registration-error") as HTMLParagraphElement;
                    ...
                    <div id="registration-window">
                        <div className="sign-buttons">
                            ...
                            <div className="sign-up-up">
                                <button className="wide_button" id="sign-up-button-registration">
                                    Sign Up
                                </button>
                            </div>
                        </div>
                        <div className="main-content">
                            ...
                            <form id="registration-form" onSubmit={handleSubmit}>
                                ...
                                <label htmlFor="password-input-registration">
                                    Password
                                    <input type="password" className="input_box" id="password-input-registration"
                                           required/>
                                </label>
